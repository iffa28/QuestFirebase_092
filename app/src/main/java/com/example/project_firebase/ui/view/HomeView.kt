...
import com.example.project_firebase.R
...
import com.example.project_firebase.ui.viewModel.HomeViewModel
...
fun HomeStatus(
    ...
    when(homeUiState) {
        is HomeUiState.Loading -> OnLoading(modifier = modifier.fillMaxWidth())
